...
if (document.getElementById && document.childNodes && document.createElement) {
    if (! (window.MathJax && MathJax.Hub)) {
        ...
        MathJax.cdnFileVersions = {}; (function(d) {
            var b = window[d];
            if (!b) {
                b = window[d] = {}
            }
        ...
        MathJax.Hub = {
            ...
            formatError: function(b, e) {
                ...
                if (MathJax.Extension.MathEvents) {
                    ...
                    MathJax.Ajax.Require("[MathJax]/extensions/MathEvents.js",
                    function() {
                        c.oncontextmenu = MathJax.Extension.MathEvents.Event.Menu;
                        c.onmousedown = MathJax.Extension.MathEvents.Event.Mousedown
                    })
        ...
        MathJax.Hub.Startup = {
            ...
            MenuZoom: function() {
                if (MathJax.Hub.config.showMathMenu) {
                    if (!MathJax.Extension.MathMenu) {
                        setTimeout(function() {
                            MathJax.Callback.Queue(["Require", MathJax.Ajax, "[MathJax]/js/MathMenu.js", {}], ["loadDomain", MathJax.Localization, "MathMenu"])
                        },
                        1000)
                    } else {
                    ...
                    if (!MathJax.Extension.MathZoom) {
                        setTimeout(MathJax.Callback(["Require", MathJax.Ajax, "[MathJax]/js/MathZoom.js", {}]), 2000)
                    }
                }
            },
            onLoad: function() {
            ...
            var g = MathJax.Object.Subclass({
                ...
                loadComplete: function(i) {
                    if (i === "config.js") {
                        ...
                        this.config || {},
                        this.id], ["Post", c.Startup.signal, this.id + " Jax Startup"], ["Startup", this], ["Post", c.Startup.signal, this.id + " Jax Ready"]);
            ...
            c.queue.Push(["Post", r.signal, "Begin"], ["Config", r], ["Cookie", r], ["Styles", r], ["Message", r],
            function() {
