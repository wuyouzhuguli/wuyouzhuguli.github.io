    ...
    i = {
        init: function(a) {
            ...
            this.each(function() {
                ...
                a), e.data(n, {
                    options: a
                }), a.timeout && i.addTimer.call(o), a.onLoadEvent && s.on("load." + n,
                function() {
                ...
                function() {}), r.on("click." + n, a.linkElement,
                function(n) {
                    n.preventDefault();
                    var a = t(this),
                    e = a.attr("href");
        ...
        addLoading: function(n) {
            t(n.loadingParentElement).append('<div class="' + n.loadingClass + '"><div></div><div></div><div></div><div></div><div></div></div>');
        },
