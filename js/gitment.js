    ...
    if (error === _constants.NOT_INITIALIZED_ERROR && user.login && user.login.toLowerCase() === instance.owner.toLowerCase()) {
      ...
      initButton.onclick = function () {
        ...
        instance.init().catch(function (e) {
          ...
          swal({
                title: "",
                text: "<span style=\"font-size:1.45rem;font-weight:600;font-family:'.SFNSText-Regular', 'San Francisco', 'Roboto', 'Segoe UI', 'Helvetica Neue', 'Lucida Grande', Arial, sans-serif;\">"+e+"</span>",
                html: true,
                allowEscapeKey: true,
