!function(e, t) {
    ...
    return function(e) {
        ...
        var l = [], o = function() {
            function e(t) {
                function a(e) {
                    for (var t = e.offsetLeft, a = e.offsetParent, n = void 0; null !== a; ) t += a.offsetLeft, 
                    a = a.offsetParent;
                    return n = document.body.scrollLeft + document.documentElement.scrollLeft, t - n;
                }
                function n(e) {
                    for (var t = e.offsetTop, a = e.offsetParent, n = void 0; null !== a; ) t += a.offsetTop, 
                    a = a.offsetParent;
                ...
                if (this.option = t, this.audios = [], this.mode = t.mode, this.secondToTime = function(e) {
                    ...
                    var t = function(e) {
                        return e < 10 ? "0" + e : "" + e;
                    }, a = parseInt(e / 60), n = parseInt(e - 60 * a), r = parseInt(a / 60), i = parseInt(e / 60 - 60 * parseInt(e / 60 / 60));
                ...
                this.lrcs = [], this.updateBar = function(e, t, a) {
                    ...
                    if (i.lrcIndex > i.lrc.length - 1 || e < i.lrc[i.lrcIndex][0] || !i.lrc[i.lrcIndex + 1] || e >= i.lrc[i.lrcIndex + 1][0]) for (var t = 0; t < i.lrc.length; t++) e >= i.lrc[t][0] && (!i.lrc[t + 1] || e < i.lrc[t + 1][0]) && (i.lrcIndex = t, 
                    i.lrcContents.style.transform = "translateY(" + 16 * -i.lrcIndex + "px)", i.lrcContents.style.webkitTransform = "translateY(" + 16 * -i.lrcIndex + "px)", 
                    i.lrcContents.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"), 
                    i.lrcContents.getElementsByTagName("p")[t].classList.add("aplayer-lrc-current"));
                };
                ...
                }, this.playIndex = 0, this.multiple = "[object Array]" === Object.prototype.toString.call(t.music), 
                this.multiple || (this.option.music = [ this.option.music ]), this.music = this.option.music[this.playIndex], 
                this.option.showlrc && this.element.classList.add("aplayer-withlrc"), this.option.music.length > 1 && this.element.classList.add("aplayer-withlist"), 
                ...
                y += "\n                </ol>\n            </div>", this.element.innerHTML = y, 
                this.element.offsetWidth < 300 && (this.element.getElementsByClassName("aplayer-icon-mode")[0].style.display = "none"), 
                this.ptime = this.element.getElementsByClassName("aplayer-ptime")[0], this.element.getElementsByClassName("aplayer-info")[0].offsetWidth < 200 && this.element.getElementsByClassName("aplayer-time")[0].classList.add("aplayer-time-narrow");
                var m = {};
                m.barWrap = this.element.getElementsByClassName("aplayer-bar-wrap")[0], this.option.narrow && this.element.classList.add("aplayer-narrow"), 
                this.button = this.element.getElementsByClassName("aplayer-button")[0], this.button.addEventListener("click", function(e) {
                    i.toggle();
                });
                ...
                m.barWrap.addEventListener("click", function(e) {
                    ...
                    isNaN(i.audio.duration) ? i.updateBar("played", 0, "width") : (i.updateBar("played", n, "width"), 
                    i.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = i.secondToTime(n * i.audio.duration), 
                    i.audio.currentTime = parseFloat(m.playedBar.style.width) / 100 * i.audio.duration);
                ...
                var b = function(e) {
                    ...
                    n = n > 0 ? n : 0, n = n < 1 ? n : 1, i.updateBar("played", n, "width"), i.option.showlrc && i.updateLrc(parseFloat(m.playedBar.style.width) / 100 * i.audio.duration), 
                    i.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = i.secondToTime(n * i.audio.duration);
                }, x = function e() {
                    document.removeEventListener("mouseup", e), document.removeEventListener("mousemove", b), 
                    isNaN(i.audio.duration) ? i.updateBar("played", 0, "width") : (i.audio.currentTime = parseFloat(m.playedBar.style.width) / 100 * i.audio.duration, 
                    i.playedTime = setInterval(function() {
                        i.updateBar("played", i.audio.currentTime / i.audio.duration, "width"), i.option.showlrc && i.updateLrc(), 
                ...
                v.addEventListener("mousedown", function() {
                    g = m.barWrap.clientWidth, clearInterval(i.playedTime), document.addEventListener("mousemove", b), 
                ...
                this.element.getElementsByClassName("aplayer-volume-bar-wrap")[0].addEventListener("click", function(e) {
                    ...
                    i.audio.muted ? (i.audio.muted = !1, i.volumeicon.className = 1 === i.audio.volume ? "aplayer-icon aplayer-icon-volume-up" : "aplayer-icon aplayer-icon-volume-down", 
                    1 === i.audio.volume ? (i.volumeicon.className = "aplayer-icon aplayer-icon-volume-up", 
                    i.volumeicon.innerHTML = i.getSVG("volume-up")) : (i.volumeicon.className = "aplayer-icon aplayer-icon-volume-down", 
                    i.volumeicon.innerHTML = i.getSVG("volume-down")), i.updateBar("volume", i.audio.volume, "height")) : (i.audio.muted = !0, 
                    i.volumeicon.className = "aplayer-icon aplayer-icon-volume-off", i.volumeicon.innerHTML = i.getSVG("volume-off"), 
                ...
                A.addEventListener("click", function() {
                    ...
                    A.innerHTML = i.getSVG(i.mode), i.audio.loop = !(i.multiple || "order" === i.mode);
            ...
            return i(e, [ {
                ...
                value: function(e) {
                    ...
                    this.music = this.option.music[a], this.music.pic && (this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url('" + this.music.pic + "')"), 
                    ...
                    !this.isMobile && this.audio && (this.pause(), this.audio.currentTime = 0), this.element.getElementsByClassName("aplayer-list")[0].scrollTop = 33 * a, 
                    this.isMobile && this.audio ? (this.audio.src = this.music.url, this.play()) : !this.isMobile && this.audios[a] ? (this.audio = this.audios[a], 
                    this.audio.volume = parseInt(this.element.getElementsByClassName("aplayer-volume")[0].style.height) / 100, 
                    this.audio.currentTime = 0) : (this.audio = document.createElement("audio"), this.audio.src = this.music.url, 
                    this.audio.preload = this.option.preload ? this.option.preload : "auto", this.audio.addEventListener("play", function() {
                        if (t.button.classList.contains("aplayer-play")) {
                            if (t.button.classList.remove("aplayer-play"), t.button.classList.add("aplayer-pause"), 
                            t.button.innerHTML = "", setTimeout(function() {
                        ...
                        t.button && (t.button.classList.contains("aplayer-pause") || t.ended) && (t.ended = !1, 
                        t.button.classList.remove("aplayer-pause"), t.button.classList.add("aplayer-play"), 
                        t.button.innerHTML = "", setTimeout(function() {
                        ...
                        t.multiple ? 0 !== t.audio.currentTime && ("random" === t.mode ? t.setMusic(t.nextRandomNum()) : "single" === t.mode ? t.setMusic(t.playIndex) : "order" === t.mode ? t.playIndex < t.option.music.length - 1 ? t.setMusic(++t.playIndex) : (t.ended = !0, 
                        t.pause(), t.trigger("ended")) : "circulation" === t.mode && (t.playIndex < t.option.music.length - 1 ? t.setMusic(++t.playIndex) : t.setMusic(0))) : "order" === t.mode && (t.ended = !0, 
                        t.pause(), t.trigger("ended"));
                    }), this.audio.volume = parseInt(this.element.getElementsByClassName("aplayer-volume")[0].style.height) / 100, 
                    this.audio.loop = !(this.multiple || "order" === this.mode), this.audios[a] = this.audio);
                    var n = function(e) {
                        for (var t = e.split("\n"), a = [], n = t.length, r = 0; r < n; r++) {
                            var i = t[r].match(/\[(\d{2}):(\d{2})\.(\d{2,3})]/g), l = t[r].replace(/\[(\d{2}):(\d{2})\.(\d{2,3})]/g, "").replace(/^\s+|\s+$/g, "");
                            if (null != i) for (var o = i.length, s = 0; s < o; s++) {
                                var p = /\[(\d{2}):(\d{2})\.(\d{2,3})]/.exec(i[s]), c = 60 * p[1] + parseInt(p[2]) + parseInt(p[3]) / (2 === (p[3] + "").length ? 100 : 1e3);
                                a.push([ c, l ]);
                            }
                        }
                    ...
                    if (this.option.showlrc) {
                        ...
                        if (!this.lrcs[r]) {
                            ...
                            if (1 === this.option.showlrc) i = this.option.music[r].lrc; else if (2 === this.option.showlrc || !0 === this.option.showlrc) i = this.savelrc[r]; else if (3 === this.option.showlrc) {
                                ...
                                o.onreadystatechange = function() {
                                    if (4 === o.readyState) {
                                        o.status >= 200 && o.status < 300 || 304 === o.status ? (i = o.responseText, t.lrcs[r] = n(i)) : (console.log("Request was unsuccessful: " + o.status), 
                                        t.lrcs[r] = [ [ "00:00", "Not available" ] ]), t.lrc = t.lrcs[r];
                                        var e = "";
                                        t.lrcContents = t.element.getElementsByClassName("aplayer-lrc-contents")[0];
                                        for (var a = 0; a < t.lrc.length; a++) e += "<p>" + t.lrc[a][1] + "</p>";
                                        t.lrcContents.innerHTML = e, t.lrcIndex || (t.lrcIndex = 0), t.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), 
                                        t.lrcContents.style.transform = "translateY(0px)", t.lrcContents.style.webkitTransform = "translateY(0px)";
                                    }
                                };
                                var s = void 0;
                        ...
                        this.lrcContents.innerHTML = p, this.lrcIndex || (this.lrcIndex = 0), this.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), 
                        this.lrcContents.style.transform = "translateY(0px)", this.lrcContents.style.webkitTransform = "translateY(0px)";
                    }
                    ...
                    this.option.autoplay && !this.isMobile && this.play(), this.option.autoplay = !0;
                }
            }, {
                key: "play",
                value: function(e) {
                ...
                value: function(e) {
                    ...
                    1 === e ? (this.volumeicon.className = "aplayer-icon aplayer-icon-volume-up", this.volumeicon.innerHTML = this.getSVG("volume-up")) : (this.volumeicon.className = "aplayer-icon aplayer-icon-volume-down", 
                ...
                value: function() {
                    ...
                    this.multiple && (this.randomOrder = function(t) {
                        for (var a, n = t.length, r = new Array(n), i = 0; i < n; i++) a = e(0, i), a !== i && (r[i] = r[a]), 
                        r[a] = t[i];
                        return r;
                ...
                value: function(e) {
                    ...
                    a.innerHTML += n, this.multiple || (this.multiple = !0, this.element.classList.add("aplayer-withlist"), 
                    this.audio.loop = !1), t.style.height = "auto", t.style.height = t.offsetHeight + "px", 
                    this.getRandomOrder();
                }
            } ]), e;
        }();
        ...
        e.exports = function(e) {
            ...
            return t.toString = function() {
                ...
                for (r = 0; r < e.length; r++) {
                    var l = e[r];
                    "number" == typeof l[0] && n[l[0]] || (a && !l[2] ? l[2] = a : a && (l[2] = "(" + l[2] + ") and (" + a + ")"), 
                    t.push(l));
                }
            }, t;
        };
        ...
        function r(e, t) {
            for (var a = [], n = {}, r = 0; r < e.length; r++) {
                var i = e[r], l = t.base ? i[0] + t.base : i[0], o = i[1], s = i[2], p = i[3], c = {
                    css: o,
                    media: s,
                    sourceMap: p
                };
                n[l] ? n[l].parts.push(c) : a.push(n[l] = {
                    id: l,
                    parts: [ c ]
                });
            }
        ...
        function i(e, t) {
            ...
            var n = b[b.length - 1];
            if ("top" === e.insertAt) n ? n.nextSibling ? a.insertBefore(t, n.nextSibling) : a.appendChild(t) : a.insertBefore(t, a.firstChild), 
            b.push(t); else {
        ...
        function s(e) {
            ...
            return e.attrs.type = "text/css", e.attrs.rel = "stylesheet", p(t, e.attrs), i(e, t), 
            t;
        }
        function p(e, t) {
        ...
        function c(e, t) {
            ...
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (a = s(t), 
            n = y.bind(null, a, t), r = function() {
        ...
        e.exports = function(e) {
            ...
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e, t) {
                ...
                var i;
                return i = 0 === r.indexOf("//") ? r : 0 === r.indexOf("/") ? a + r : n + r.replace(/^\.\//, ""), 
